...
%-----------------------------------------------------------------------------
\usepackage{simplinvoice}			% <= This is what we're here for :)
...
%-----------------------------------------------------------------------------
		\InvoiceLine[e]{2}{4711}{Schlappeseppel Pils\tab 0,50\,ℓ}		{3,60}
		\InvoiceLine[e]{12}{4712}{Fritz Kola, süß-sauer \tab 0,33\,ℓ}	{2,20}
...
%-----------------------------------------------------------------------------
		...
		\SeparatorOff				% Horizontal lines? Heck, no.
%-----------------------------------------------------------------------------
		\InvoiceLine{20}{Fritz Kola, orange \tab 0,33\,ℓ}	{2,20}
			% Depending on the item, decimal values are allowed
		\InvoiceLine{10}{Kleine Pizza}							{8,90}
		\InvoiceLine{500}{Kopien \tab A4}						{0,20}
		\InvoiceLine{150}{Druck Flyer \tab A5}					{0,72}
		\InvoiceLine{2,25}{Arbeitsstunden Praktikant}				{25}
	\end{invoice}
...
%-----------------------------------------------------------------------------
		...
		\SeparatorOff				% Horizontal lines? Heck, no.
%-----------------------------------------------------------------------------
		\InvoiceLine{1}{~}{Administrative Fee \tab(flat)}			{50,00}
		\InvoiceLine{8,3}{hrs}{Legal Research \tab(Associate)}		{250,00}
		\InvoiceLine{0,5}{hrs}{Motion drafted \tab(Junior Partner)}	{400,00}
		\InvoiceLine{0,4}{hrs}{Motion reviewed and filed \tab(Senior Partner)}	{650,00}
	\end{invoice*}
