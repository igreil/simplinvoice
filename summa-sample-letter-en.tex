...
\setkomavar{fromaddress}	{3816 Glenview Drive, Corpus Christi, TX 78479}
%-----------------------------------------------------------------------------
...
%-----------------------------------------------------------------------------
	\begin{flushright}					% SECOND LINE OF MASTHEAD
		\color{mycolor}
			...
			Proudly fulfilling your late night cravings since 1991
	\end{flushright}
}%----------------------------------------------------------------------------
...
\InvoiceLine{2.5}	{Work Hours (Intern)}						{25.00}
%=============================================================================
...
\marginpar{\textbf{FIXME} •\;Currency •\;German •\;Decimals}
...
%	A few definitions for the payment QR-code:
	...
	\def\currcode	{USD}					% probably the only sensible choice
