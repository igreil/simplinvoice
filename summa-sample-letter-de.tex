...
%-----------------------------------------------------------------------------
	\begin{center}						% SECOND LINE OF MASTHEAD
		\color{mycolor}					% Separate environment, so you 
			...
			Im Nirgendwo 81-83, 1280 Wien • www.example.com • Tel. (01) 00 00 001
...
\begin{document}	\def\payperiod		{7}		% How many days to pay?
...
%-----------------------------------------------------------------------------	
		...
		\begin{invoice*}[N]				% N = Netto			(Net)
			...
			% Invoice table header formatting
...
\InvoiceLine[e]{7}	{47-13}		{Koala-Kola, bitter \tab 0,33\,ℓ}	{2,20}
\InvoiceLine[e]{3}	{47-13}		{Koala-Kola, salzig \tab 0,33\,ℓ}	{2,20}
\InvoiceLine[e]{1}	{47-14}		{Koala-Kola, umami \tab 0,33\,ℓ}	{2,20}
\InvoiceLine[e]{8}	{47-99}		{Große Pizza}						{15,50}
\InvoiceLine{150}	{08-15}		{Plakatdruck \tab A3}				{3,25}
...
\end{textblock*}
		...
		\setkomavar{signature}{P. Rokurist~p.\kern 1pt p.\kern 1pt a}
